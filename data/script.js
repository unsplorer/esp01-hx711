...
document.getElementById("new-toast-calibrate").addEventListener("click", function() {
Toastify({
  text: "Starting Caibration",
  duration: 3000,
...
document.getElementById("new-toast-tare").addEventListener("click", function() {
  Toastify({
    text: "Tare Complete",
    duration: 3000,
    close: i % 3 ? true : false,
